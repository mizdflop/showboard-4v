		...
		data: {
			...
			comments: function () { 
				if(Session.equals("sortedBy", "Most Recent")){
					return Comments.find({parentId: "0"}, {sort: {timestamp: -1}});
				} else if (Session.equals("sortedBy", "Most Recommended")){
					return Comments.find({parentId: "0"}, {sort: {numberRecommendations: -1, timestamp: -1}});
				} else if (Session.equals("sortedBy", "Most Replies")){
					return Comments.find({parentId: "0"}, {sort: {numberReplies: -1, timestamp: -1}});
				}
